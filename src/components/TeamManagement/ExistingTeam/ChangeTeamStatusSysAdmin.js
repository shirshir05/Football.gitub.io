...
function ChangeTeamStatusSysAdmin(props) {
            ...
            <form>
                ...
                <div className="form-group text-center">
                    ...
                    <select id="status" value={details.status} onChange={handleChange} className="dropdown-toggle btn btn-primary">
                        ...
                        <option value="-1" className="form-control">Permanently Closed</option>
                    </select>
                    </Container>
                </div>
...
export default withRouter(ChangeTeamStatusSysAdmin);